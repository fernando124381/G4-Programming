...
print (f"And to his surprise, a giant {Animal} was trying to {Verb_infinitive1} in the corner of the room.")

print (f"To clear his mind, he decided to drink a large glass of ice-cold {Liquid},")
print (f"But as he brought it to his lips, he felt his {Body_part_plural} start to blink uncontrollably.")
print (f"Suddenly, a secret {Noun1} opened in the wall, and a mysterious {Profession} appeared,")
